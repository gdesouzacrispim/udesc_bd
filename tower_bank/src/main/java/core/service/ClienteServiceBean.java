...
public class ClienteServiceBean implements ClienteService{
    ...
    public void create(Driver con) throws Exception {
        ...
        ClienteDAO.create(con, cliente);
    }

    @Override
    public void delete(Driver con) throws SQLException {
    ...
    @Override
    public void update(Driver con, Conta conta) throws Exception {
    ...
    @Override
    public List<Cliente> listAll(Driver con) throws SQLException {
        return ClienteDAO.listaAllClientes(con);
    }

    @Override
    public Cliente getById(Driver con, Integer id) throws Exception {
    ...
    @Override
    public void listByCidade(Driver connection) throws SQLException, IOException, CampoInvalidoExceptions {
